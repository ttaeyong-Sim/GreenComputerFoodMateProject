...
public class InquiryDTO {
    ...
    // 파일 업로드 관련 필드 추가
    private List<String> imagePaths;  // 파일 경로를 저장할 List (이미지 파일 경로)
    private List<String> imageNames;  // 업로드된 이미지 이름을 저장할 List (이미지 이름)
