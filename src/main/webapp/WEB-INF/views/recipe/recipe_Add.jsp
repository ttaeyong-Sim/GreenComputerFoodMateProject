    ...
    <div class="recipe-form-container">
        ...
        <form action="/submit-recipe" method="POST">
            ...
            <div class="form-group input-box">
                ...
                <input type="text" id="recipeTitle" name="recipeTitle" placeholder="레시피 제목을 입력하세요" required>
            </div>

            <!-- 음식명 -->
            <div class="form-group input-box">
                <label for="recipeName">음식명</label>
                <input type="text" id="recipeName" name="recipeName" placeholder="음식명을 입력하세요" required>
            </div>
            ...
            <div class="form-group input-box">
                ...
                <textarea id="recipeDescription" name="recipeDescription" rows="4" placeholder="레시피 소개글을 작성하세요" required></textarea>
            </div>

			<!-- 재료 1 -->
			<div class="form-group input-box">
			    <label for="ingredientType1">재료 유형 1</label>
			    <input type="text" id="ingredientType1" class="ingredient-input" placeholder="재료 유형을 입력하세요">
			...
			<div class="form-group input-box">
			    ...
			    <input type="text" id="ingredientType2" class="ingredient-input" placeholder="재료 유형을 입력하세요">
			...
			<div class="form-group input-box">
			    ...
			    <input type="text" id="ingredientType3" class="ingredient-input" placeholder="재료 유형을 입력하세요">
            ...
            <!-- 제출 버튼 -->
            <button type="submit" class="submit-btn">레시피 작성하기</button>
        </form>
    </div>
